  ...
  <body>
    ...
    <header class="navbar">
      ...
      <nav class="navbar-links" id="navbarLinks">
        <a href="{{ route('mahasiswa.modul') }}" class="active">Modul</a>
        <a href="#" title="TODO: menyusul (grup mahasiswa)">Leaderboard</a>
        <a href="#" title="TODO: menyusul (grup mahasiswa)">Dashboard</a>
        <a href="#" title="TODO: menyusul (grup mahasiswa)">Info</a>
        <a href="#" title="TODO: menyusul (grup mahasiswa)">Profil</a>
      </nav>
    </header>
    ...
    <nav class="bottom-nav" aria-label="Navigasi bawah">
      <a href="{{ route('mahasiswa.modul') }}" class="active">
        <svg
          class="ic"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <a href="#" title="TODO: menyusul (grup mahasiswa)">
        <svg
          class="ic"
          viewBox="0 0 24 24"
          fill="none"
      ...
      <a href="#" title="TODO: menyusul (grup mahasiswa)" class="home" aria-label="Beranda">
        <svg
          class="ic"
          viewBox="0 0 24 24"
          fill="none"
