...
<div class="mb-5 flex items-start justify-between flex-wrap gap-3">
    <div>
        <a href="{{ route($monBase.'.keaktifan') }}" class="text-sm font-semibold text-teal-600 inline-flex items-center gap-1 mb-3">
    ...
    <div class="flex items-center gap-2">
        <a href="{{ route($monBase.'.keaktifan.export-pdf', ['groupId' => $group->id]) }}" target="_blank"
        ...
        <a href="{{ route($monBase.'.keaktifan.export-excel', ['groupId' => $group->id]) }}"
