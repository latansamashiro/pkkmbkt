    ...
    <div class="relative z-[1] max-w-[1200px] mx-auto flex flex-wrap justify-between items-end gap-7">
      <div class="flex-1" style="min-width: 280px;">
        <div class="inline-flex items-center gap-[7px] text-[#c8e46a] text-[11px] font-bold rounded-full mb-4 tracking-[0.06em] uppercase" style="background: rgba(169,199,59,.15); border: 1px solid rgba(169,199,59,.35); padding: 5px 14px;">
          <span class="w-1.5 h-1.5 rounded-full bg-lime-500" style="animation: pulse 2s infinite;"></span> Monitoring
        </div>
  ...
  <script>
    $(function() {
      ...
      const KATEGORI_EVALUASI = [{
        ...
        {
          id: "akademik",
          nama: "Evaluasi Akademik"
        },
        {
          id: "kemahasiswaan",
          nama: "Evaluasi Kemahasiswaan"
        },
        {
          id: "tatib",
          nama: "Evaluasi Tata Tertib"
        },
        {
          id: "organisasi",
      ...
      const ANGGOTA_KELOMPOK = [{
          ...
          hasil: {
            keuangan: {
              selesai: true,
              skor: 90,
              waktu: "07 Sep 2026, 09:15"
            },
            akademik: {
              selesai: true,
              skor: 80,
              waktu: "07 Sep 2026, 09:40"
            },
            kemahasiswaan: {
              selesai: true,
              skor: 70,
              waktu: "08 Sep 2026, 10:05"
            },
            tatib: {
              selesai: false,
              skor: null,
        ...
        },
        {
          ...
          hasil: {
            keuangan: {
              selesai: true,
              skor: 100,
              waktu: "07 Sep 2026, 08:52"
            },
            akademik: {
              selesai: true,
              skor: 90,
              waktu: "07 Sep 2026, 09:10"
            },
            kemahasiswaan: {
              selesai: true,
              skor: 85,
              waktu: "07 Sep 2026, 09:33"
            },
            tatib: {
              selesai: true,
              skor: 80,
              waktu: "08 Sep 2026, 08:20"
            },
            organisasi: {
              selesai: true,
              skor: 75,
              waktu: "08 Sep 2026, 08:41"
            },
            kampus: {
              selesai: true,
              skor: 95,
              waktu: "08 Sep 2026, 09:02"
            },
          },
        },
        {
        ...
        },
        {
          ...
          hasil: {
            keuangan: {
              selesai: true,
              skor: 65,
              waktu: "07 Sep 2026, 11:02"
            },
            akademik: {
              selesai: true,
              skor: 70,
              waktu: "07 Sep 2026, 11:25"
            },
            kemahasiswaan: {
              selesai: false,
              skor: null,
        ...
        },
        {
          ...
          hasil: {
            keuangan: {
              selesai: true,
              skor: 78,
              waktu: "08 Sep 2026, 13:05"
            },
            akademik: {
              selesai: true,
              skor: 82,
              waktu: "08 Sep 2026, 13:28"
            },
            kemahasiswaan: {
              selesai: true,
              skor: 75,
              waktu: "08 Sep 2026, 13:50"
            },
            tatib: {
              selesai: false,
              skor: null,
        ...
        },
        {
          ...
          hasil: {
            keuangan: {
              selesai: true,
              skor: 95,
              waktu: "07 Sep 2026, 08:30"
            },
            akademik: {
              selesai: true,
              skor: 92,
              waktu: "07 Sep 2026, 08:55"
            },
            kemahasiswaan: {
              selesai: true,
              skor: 88,
              waktu: "07 Sep 2026, 09:18"
            },
            tatib: {
              selesai: true,
              skor: 90,
              waktu: "08 Sep 2026, 08:02"
            },
            organisasi: {
              selesai: true,
              skor: 85,
              waktu: "08 Sep 2026, 08:24"
            },
            kampus: {
              selesai: true,
              skor: 93,
              waktu: "08 Sep 2026, 08:47"
            },
          },
        },
        {
