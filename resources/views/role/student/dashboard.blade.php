  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      /* ►► TIDAK LAGI STICKY — ikut scroll ke bawah bersama halaman,
         baik di mode HP maupun desktop. */
      .sidebar {
        display: none;
      ...
      /* Topbar — ►► TIDAK LAGI STICKY, ikut scroll turun bersama halaman */
      .topbar {
        display: flex;
        align-items: center;
      ...
      /* ============ HERO ============ */
      /* ►► LATAR HERO — sebelumnya coba pakai foto file "masjid.jpeg" yang
         ternyata tidak ada filenya. Sekarang ilustrasi masjidnya digambar
         langsung pakai SVG (elemen <svg class="hero-mosque"> di HTML di
         bawah), jadi tidak butuh file gambar sama sekali. */
      .hero {
        position: relative;
        overflow: hidden;
  ...
  <body>
      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav" aria-label="Navigasi utama">
          ...
          <a href="{{ route('role.student.leaderboard') }}">
            ...
            <span class="label">Leaderboard</span> <!-- Leaderboard-->
          </a>
          <a href="#" class="active">
            <svg
              class="ic"
            ...
            <span class="label">Dashboard</span> <!-- info-->
          </a>
            ...
            <section class="section">
              ...
              <div class="menu-grid">
                ...
                <a class="menu-card" href="{{ route('role.student.absensi') }}">
                  ...
                  <span class="menu-desc"
                    >Cek absensi dan status tugas harianmu</span
                  >
                </a>
                ...
                <a class="menu-card" href="{{ route('role.student.leaderboard') }}">
                  ...
                  <span class="menu-desc"
                    >Pantau peringkat poin keaktifanmu</span
                  >
                </a>
                ...
                <a class="menu-card" href="{{ route('role.student.denah-kampus') }}">
                  ...
                  <span class="menu-desc"
                    >Temukan lokasi kegiatan di kampus</span
                  >
                </a>
                ...
                <a class="menu-card" href="{{ route('role.student.materi') }}">
                  ...
                  <span class="menu-desc"
                    >Kerjakan tes pemahaman materi PKKMB</span
                  >
                </a>
                ...
                <a class="menu-card" href="{{ route('role.student.evaluasi') }}">
                 ...
                 <a class="menu-card" href="{{ route('role.student.keaktifan') }}">
                  ...
                  <span class="menu-desc"
                    >Monitoring Keaktifan & Pelanggaran</span
                  >
                </a>
              </div>
            </section>
    ...
    <script>
      ...
      function bukaModalLogout(e) {
        e.preventDefault();
        logoutTargetUrl = this.getAttribute("href");
