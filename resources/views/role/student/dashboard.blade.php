...
<head>
    ...
    <title>Dashboard Mahasiswa &mdash; PKKMB-KT UNILAM 2026</title>
    ...
    <div class="placeholder-page">
        ...
        <div class="placeholder-body">
            <div class="placeholder-card">
                ...
                <span class="placeholder-role">STUDENT</span>
                <h1 class="placeholder-title">Halo, {{ auth()->user()->name }}</h1>
                <p class="placeholder-desc">
                    Dashboard Mahasiswa sedang disiapkan. Halaman ini akan diganti dengan
                    tampilan dan menu Mahasiswa yang sesungguhnya.
                </p>
            </div>
        </div>
    </div>
