    ...
    <div
      ...
      <table class="w-full border-collapse mt-3.5 rounded-[13px] overflow-hidden border border-border">
        ...
        <tr class="bg-bg">
          ...
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900"><span class="text-plus-500 font-extrabold bg-plus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">+10</span></td>
        </tr>
        <tr>
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900">Membantu teman</td>
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900"><span class="text-plus-500 font-extrabold bg-plus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">+5</span></td>
        </tr>
        <tr class="bg-bg">
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900">Menjadi sukarelawan saat kegiatan</td>
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900"><span class="text-plus-500 font-extrabold bg-plus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">+7</span></td>
        </tr>
        <tr>
          <td class="px-3.5 py-[13px] text-[13.5px] text-ink-900">Menjaga kebersihan</td>
          <td class="px-3.5 py-[13px] text-[13.5px] text-ink-900"><span class="text-plus-500 font-extrabold bg-plus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">+3</span></td>
        </tr>
      </table>
      ...
      <table class="w-full border-collapse mt-3.5 rounded-[13px] overflow-hidden border border-border">
        ...
        <tr class="bg-bg">
          ...
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900"><span class="text-minus-500 font-extrabold bg-minus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">-15</span></td>
        </tr>
        <tr>
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900">Tidak rapi / atribut tidak lengkap</td>
          <td class="px-3.5 py-[13px] border-b border-border text-[13.5px] text-ink-900"><span class="text-minus-500 font-extrabold bg-minus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">-5</span></td>
        </tr>
        <tr class="bg-bg">
          <td class="px-3.5 py-[13px] text-[13.5px] text-ink-900">Mengganggu jalannya kegiatan</td>
          <td class="px-3.5 py-[13px] text-[13.5px] text-ink-900"><span class="text-minus-500 font-extrabold bg-minus-tint px-2.5 py-[3px] rounded-full text-xs inline-block">-10</span></td>
        </tr>
      </table>
