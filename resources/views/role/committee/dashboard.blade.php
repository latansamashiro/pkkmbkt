    ...
    <div class="placeholder-page">
        ...
        <div class="placeholder-body">
            <div class="placeholder-card">
                ...
                <span class="placeholder-role">COMMITTEE</span>
                <h1 class="placeholder-title">Halo, {{ auth()->user()->name }}</h1>
                <p class="placeholder-desc">
                    Dashboard Panitia sedang disiapkan. Halaman ini akan diganti dengan
                    tampilan dan menu Panitia yang sesungguhnya.
                </p>
            </div>
        </div>
    </div>
