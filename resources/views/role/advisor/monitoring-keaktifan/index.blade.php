...
<div class="flex items-center justify-between flex-wrap gap-3 mb-5">
    <div>
        ...
        <h2 class="text-2xl font-extrabold text-slate-800 m-0">Monitoring Keaktifan</h2>
            ...
            <tbody>
                @forelse ($laporan as $idx => $l)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-3.5 py-3 text-sm font-extrabold text-teal-600 border-b border-slate-200 text-center">{{ $l['poin'] }}</td>
                        ...
                        <td class="px-3.5 py-3 border-b border-slate-200">
                            <a href="{{ route('role.advisor.monitoring.keaktifan.detail', $l['group_id']) }}" class="text-teal-600 hover:text-teal-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center py-6 text-slate-400 text-sm">Tidak ada data keaktifan ditemukan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
