...
<div class="flex items-center justify-between flex-wrap gap-3 mb-5">
    <div>
        ...
        <h2 class="text-2xl font-extrabold text-slate-800 m-0">Monitoring Evaluasi</h2>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            ...
            <tbody>
                @forelse ($laporan as $idx => $l)
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-3.5 py-3 border-b border-slate-200">
                            <a href="{{ route('role.advisor.monitoring.evaluasi.detail', $l['group_id']) }}" class="text-teal-600 hover:text-teal-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center py-6 text-slate-400 text-sm">Tidak ada data evaluasi ditemukan.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
