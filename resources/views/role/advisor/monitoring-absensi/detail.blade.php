...
<div class="mb-5 flex items-start justify-between flex-wrap gap-3">
    <div>
        <a href="{{ route('role.advisor.monitoring.absensi') }}" class="text-sm font-semibold text-teal-600 inline-flex items-center gap-1 mb-3">
    ...
    @if ($adaSubmitted)
        <div class="flex items-center gap-2">
            <a href="{{ route('role.advisor.monitoring.absensi.export-pdf', ['groupId' => $group->id, 'tanggal' => $tanggal]) }}"
                target="_blank"
            ...
            <a href="{{ route('role.advisor.monitoring.absensi.export-excel', ['groupId' => $group->id, 'tanggal' => $tanggal]) }}"
