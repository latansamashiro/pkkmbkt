...
<html lang="id">
  <head>
    ...
    />
    <title>Kebijakan Privasi | PKKMB-KT UNILAM 2026</title>
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <header class="navbar">
      ...
      <nav class="navbar-links" id="navbarLinks">
        <a href="{{ route('landing.kebijakan-privasi') }}" class="active">Kebijakan Privasi</a>
    ...
    <div class="content-wrap">
      <div class="policy-intro">
        <p>
          ...
          maupun pengunjung website.
        </p>
      </div>

      <!-- 1 -->
      <div class="policy-card">
        <h2><span class="policy-num">1</span>Informasi yang Kami Kumpulkan</h2>
        <p>Kami dapat mengumpulkan beberapa informasi, antara lain:</p>
        <ul>
          <li>Nama lengkap</li>
          ...
          <li>Alamat email</li>
          <li>Nomor telepon</li>
          <li>Data kehadiran kegiatan PKKMB</li>
          <li>Informasi lain yang diberikan melalui formulir pada website</li>
        </ul>
      </div>

      <!-- 2 -->
      <div class="policy-card">
        <h2><span class="policy-num">2</span>Tujuan Penggunaan Data</h2>
        <p>Informasi yang dikumpulkan digunakan untuk:</p>
        <ul>
          <li>Proses administrasi PKKMB-KT</li>
          <li>Verifikasi identitas peserta</li>
          <li>Penyampaian informasi kegiatan, jadwal, dan pengumuman</li>
          <li>Pendataan kehadiran dan aktivitas peserta</li>
          <li>Peningkatan kualitas layanan website</li>
        </ul>
      </div>
      ...
      <div class="policy-card">
        <h2>
          <span class="policy-num">3</span>Penyimpanan dan Keamanan Data
        </h2>
        <p>
          Kami berupaya menjaga keamanan data pengguna dengan menerapkan
          langkah-langkah teknis dan administratif yang wajar untuk mencegah
          akses, perubahan, pengungkapan, atau penghapusan data tanpa izin.
        </p>
        <p>
          Data disimpan pada sistem yang dikelola oleh Universitas La Tansa
          Mashiro dan hanya dapat diakses oleh pihak yang berwenang.
        </p>
      </div>

      <!-- 4 -->
      <div class="policy-card">
        <h2><span class="policy-num">4</span>Penggunaan Cookie</h2>
        <p>
          Website dapat menggunakan cookie untuk meningkatkan pengalaman
          pengguna, seperti menyimpan preferensi tampilan dan membantu
          analisis penggunaan website. Pengguna dapat mengatur browser untuk
          menolak cookie, namun beberapa fitur website mungkin tidak
      ...
      <div class="policy-card">
        <h2>
          <span class="policy-num">5</span>Pembagian Informasi kepada Pihak
          Ketiga
        </h2>
        <p>
          Kami tidak menjual, menyewakan, atau memperdagangkan data pribadi
          pengguna kepada pihak ketiga. Informasi hanya dapat dibagikan
          apabila:
        </p>
        <ul>
          <li>Diperlukan untuk kepentingan administrasi universitas</li>
          <li>Diwajibkan oleh peraturan perundang-undangan</li>
          <li>
            Diperlukan untuk melindungi hak, keamanan, dan kepentingan
      ...
      <!-- 6 -->
      <div class="policy-card">
        <h2><span class="policy-num">6</span>Hak Pengguna</h2>
        <p>Pengguna berhak untuk:</p>
        <ul>
          <li>Meminta akses terhadap data pribadi yang dimiliki</li>
          <li>Memperbaiki data yang tidak akurat</li>
          <li>Meminta penghapusan data sesuai ketentuan yang berlaku</li>
          <li>Mengajukan pertanyaan terkait pengelolaan data pribadi</li>
        </ul>
      </div>

      <!-- 7 -->
      <div class="policy-card">
        <h2><span class="policy-num">7</span>Tautan ke Website Lain</h2>
        <p>
          Website PKKMB-KT dapat memuat tautan ke website lain. Kami tidak
          bertanggung jawab atas kebijakan privasi atau konten pada website
      ...
      <!-- 8 -->
      <div class="policy-card">
        <h2><span class="policy-num">8</span>Perubahan Kebijakan Privasi</h2>
        <p>
      ...
      <!-- 9 — Kontak, disorot beda -->
      <div class="policy-contact">
        <h2><span class="policy-num">9</span>Kontak</h2>
        <p style="margin: 0 0 14px; color: #cfd4ee; font-size: 13.5px">
          Apabila terdapat pertanyaan mengenai Kebijakan Privasi ini, silakan
          menghubungi:
        </p>
        ...
        <p class="policy-contact-foot">
          Dengan menggunakan website ini, pengguna dianggap telah membaca,
          memahami, dan menyetujui Kebijakan Privasi yang berlaku.
        </p>
      </div>
    </div>
