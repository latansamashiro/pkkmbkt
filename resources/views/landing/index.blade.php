...
<html lang="id">
  <head>
    ...
    <style>
      ...
      * {
      ...
      /* ►► "اَهْلًا وَسَهْلًا" — DIPERBESAR di sini. Sebelumnya 20px,
         sekarang responsif (lebih besar di layar lebar, tetap proporsional
         di HP kecil) plus jarak bawah sedikit ditambah supaya tidak
         terlalu mepet ke judul di bawahnya. */
      .splash-text .ahlan {
        display: block;
        margin-bottom: 8px;
        font-style: italic;
  ...
  <body>
    ...
    <div id="splashScreen">
      ...
      <div class="greeters">
        <div class="greeter-wrap">
          <div class="speech-bubble bubble-boy">Welcome!</div>
    ...
    <script>
      ...
      // KONFIGURASI
      // ==========================================================================
      const DURASI_SPLASH_MS = 5500;
      const TUJUAN = "{{ route('landing.home') }}";
