...
<aside class="sidebar" style="display:flex; flex-direction:column; height:100vh; overflow:hidden;">
    <a href="{{ route('dashboard') }}" class="sidebar-brand" style="flex:none;">
    ...
    <!-- ⬇️ WRAPPER SCROLLABLE, scrollbar disembunyikan lewat class .sidebar-scroll -->
    <div class="sidebar-scroll" style="flex:1 1 auto; overflow-y:auto; overflow-x:hidden; min-height:0;">
    ...
    <form method="POST" action="{{ route('logout') }}" class="sidebar-logout"
        style="flex:none; border:none; padding:0; margin:10px 10px 0;">
        @csrf
        <button type="submit"
